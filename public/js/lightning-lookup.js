if("undefined"==typeof jQuery)throw new Error("Appiphony Lightning JS requires jQuery");!function(e){"undefined"==typeof e.aljs&&(e.aljs={assetsLocation:"",scoped:!0,scopingClass:"slds-scope"},e.aljsInit=function(n){e.aljs=n})}(jQuery);
/* ------------------------------------------------------------
ALJS Lookup
------------------------------------------------------------ */
...
//                        .replace('{{hasIcon}}', (self.settings.objectIconUrl !== '') ? '' : ' slds-hide')
                        ...
                        // .replace('{{objectIconClass}}', self.settings.objectIconClass)
                        .replace('{{metaLabel}}', (result.metaLabel) ? '<span class="slds-lookup__result-meta slds-text-body--small" style="display:none">' + result.metaLabel + '</span>' : ''));
